...
img_size=256
crop_size=224
model_path="results/"$model"_"$optimizer"_"$img_size"to"$crop_size"_lr"$lr"_DA_pretrained_weightedLoss/"
...
CUDA_VISIBLE_DEVICES=0 python train.py --model_name $model --optimizer $optimizer --learning_rate $lr \
                                       ...
                                       --steps_scheduler --pretrained --data_augmentation --weighted_loss
